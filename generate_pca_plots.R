...
pcplot(Xtr, btr, y=ytr, col=as.numeric(unique(btr)), main="PCA MGS 4 Cohorts PPM CDD")
...
plot(pc$x[,1], pc$x[,2], col=as.numeric(btr), main="PCA MGS 4 Cohorts PPM CDD", xlab="PC1", ylab="PC2")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
#
...
pcplot(Xtr, btr, y=ytr, col=as.numeric(unique(btr)), main="PCA MGS 4 Cohorts PPM EC")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
pc <- prcomp(Xtr, scale.=FALSE)
svg(file="results/pca_4_cohorts_ppm_ec_v2.svg")
plot(pc$x[,1], pc$x[,2], col=as.numeric(btr), main="PCA MGS 4 Cohorts PPM EC", xlab="PC1", ylab="PC2")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
#
...
pcplot(Xtr, btr, y=ytr, col=as.numeric(unique(btr)), main="PCA MGS 4 Cohorts PPM GO")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
pc <- prcomp(Xtr, scale.=FALSE)
svg(file="results/pca_4_cohorts_ppm_go_v2.svg")
plot(pc$x[,1], pc$x[,2], col=as.numeric(btr), main="PCA MGS 4 Cohorts PPM GO", xlab="PC1", ylab="PC2")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
#
...
pcplot(Xtr, btr, y=ytr, col=as.numeric(unique(btr)), main="PCA MGS 4 Cohorts PPM LKT")
legend("topright", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
pc <- prcomp(Xtr, scale.=FALSE)
svg(file="results/pca_4_cohorts_ppm_lkt_v2.svg")
plot(pc$x[,1], pc$x[,2], col=as.numeric(btr), main="PCA MGS 4 Cohorts PPM LKT", xlab="PC1", ylab="PC2")
legend("topright", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
#
...
pcplot(Xtr, btr, y=ytr, col=as.numeric(unique(btr)), main="PCA MGS 4 Cohorts PPM PFAM")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
pc <- prcomp(Xtr, scale.=FALSE)
svg(file="results/pca_4_cohorts_ppm_pfam_v2.svg")
plot(pc$x[,1], pc$x[,2], col=as.numeric(btr), main="PCA MGS 4 Cohorts PPM PFAM", xlab="PC1", ylab="PC2")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
#
...
pcplot(Xtr, btr, y=ytr, col=as.numeric(unique(btr)), main="PCA MGS 4 Cohorts PPM PRINTS")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
pc <- prcomp(Xtr, scale.=FALSE)
svg(file="results/pca_4_cohorts_ppm_prints_v2.svg")
plot(pc$x[,1], pc$x[,2], col=as.numeric(btr), main="PCA MGS 4 Cohorts PPM PRINTS", xlab="PC1", ylab="PC2")
legend("bottomleft", legend=c("gajewski","pittsburgh_sd0","wargo","zitvogel_sd0"), col=as.numeric(unique(btr)), pch=20, bty="n")
dev.off()
#
